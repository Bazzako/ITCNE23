...
HOST = "192.168.23.141" # example: 192.168.23.149
VERIFY_SSL = False
USERNAME = 'user1' # example:admin
PASSWORD = 'user1' # example:admin
WIREGUARD_INTERFACE = 'wireguard1' # example:wireguard1
NUM_OF_HOSTS_TO_ADD = 5 # example: 2
OUTPUT_DIR = 'out'
ALLOWED_IPS = "192.168.60.0/24" # example: 192.168.1.0/24
ENDPOINT = "192.168.23.141" # example: 192.168.23.149
